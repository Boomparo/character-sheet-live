const CACHE = 'character-sheet-v10-homebrew-spells-3';
const SHELL = [
  ...
  './js/core/spell-catalog-v10.js?v=10.1.1', './js/core/state-v9.js?v=10.1.2', './js/core/rules-2024.js?v=10.1.1', './js/core/origin-v9.js?v=10.1.1',
  './js/core/derived-v9.js?v=10.1.1', './js/core/commands-v9.js?v=10.1.1', './js/core/roster-v9.js?v=10.1.1',
  './js/classes/occultist/import-v10.js?v=10.1.1', './js/core/catalog-srd.js?v=10.1.1', './js/ui/portrait-cropper.js?v=10.1.1',
  './js/ui/app-v9.js?v=10.1.1', './js/ui/occultist-v10.js?v=10.1.2',
