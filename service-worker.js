const CACHE = 'character-sheet-v10-homebrew-spells-2';
const SHELL = [
  ...
  './js/core/spell-catalog-v10.js?v=10.1.1', './js/core/state-v9.js?v=10.1.1', './js/core/rules-2024.js?v=10.1.1', './js/core/origin-v9.js?v=10.1.1',
  ...
  './js/ui/app-v9.js?v=10.1.1', './js/ui/occultist-v10.js?v=10.1.1',
